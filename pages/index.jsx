...
export default function Home() {
   ...
   *  the blockchain, which involves the connected account
   * needing to make a digital signature to authorize the transaction being sent. Metamask exposes 
   * a Signer API to allow your website to
